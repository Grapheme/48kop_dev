...
<? } ?>
                    ...
                    <form class="family-form" action="/recomendations" method="POST">
                        <div class="form-head">
                            ...
                            <div class="form-desc">
                                Проведите выходные в компании близких. Спланируйте прекрасные 48 часов прямо сейчас!<br>
                                Заполни анкету и получи рекомендации на выходные!
                            </div>
                        </div>
                    ...
                    <div class="to-bot">
                        <div>Выбери свои 48 копеек на выходные!</div>
            ...
            <section class="mid">
                <div class="section-cont">
                    <div class="mid-cont">
                        ...
                        <p>
                            Мороженое 48 копеек. Вкусы для всех<br>
